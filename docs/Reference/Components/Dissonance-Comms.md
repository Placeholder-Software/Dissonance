...
### SubscribeToVoiceActivation(IVoiceActivationListener) <a id="subcribetovoiceactivationivoiceactivationlistener"></a>
...
### SubscribeToRecordedAudio(IMicrophoneSubscriber) <a id="subcribetorecordedaudioimicrophonesubscriber"></a>
