# Quick Start: Dissonance with Mirror Networking

> This Quick Start guide is for those of you integrating Dissonance into a game with the **Mirror Networking**. You must use a network backend which support unreliable networking, such as **Ignorance**.
